...
project = u'CisCamera'
copyright = u'2019, Tokyo Opensource Robotics Kyokai Association'
author = u'Tokyo Opensource Robotics Kyokai Association'

github_doc_root = 'https://github.com/tork-a/cis_camera/tree/master/doc/'
...
htmlhelp_basename = 'CisCameradoc'
...
latex_documents = [
  (master_doc, 'cis_camera.tex', u'CIS ToF Camera Documentation',
...
man_pages = [
    (master_doc, 'cis_camera', u'CIS ToF Camera Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'cis_camera', u'CIS ToF Camera Documentation',
   author, 'cis_camera', 'CIS ToF Camera',
   'Miscellaneous'),
]
